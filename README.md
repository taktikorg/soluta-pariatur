...
[![build status](https://img.shields.io/travis/taktikorg/soluta-pariatur/master.svg?style=flat-square)](https://travis-ci.org/taktikorg/soluta-pariatur)
[![npm version](https://img.shields.io/npm/v/@taktikorg/soluta-pariatur.svg?style=flat-square)](https://www.npmjs.com/package/@taktikorg/soluta-pariatur)
...
```sh
npm install @taktikorg/soluta-pariatur @stripe/stripe-js
```
...
import {
  ...
  useStripe,
  useElements,
} from '@taktikorg/soluta-pariatur';
